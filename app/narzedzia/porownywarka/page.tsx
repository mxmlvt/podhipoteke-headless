...
export const metadata: Metadata = {
  title: "Porównywarka kredytów hipotecznych | PODHIPOTEKE24.PL",
  description:
    "Porównaj oferty pożyczek pod hipotekę od różnych instytucji i wybierz najlepszą opcję dla siebie. Transparentne zestawienie kosztów, rat i warunków spłaty. Narzędzie jest w trakcie budowy.",
};

export default function PorownywarkaPage() {
  return (
    <main>
      <PageHero heading="Porównywarka kredytów" bgImage="/images/slide-1.jpg" />
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-[800px] mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-[#374151] text-lg leading-relaxed mb-10">
            Porównaj oferty pożyczek pod hipotekę od różnych instytucji i wybierz
            najlepszą opcję dla siebie. Transparentne zestawienie kosztów, rat i
            warunków spłaty. Narzędzie jest w trakcie budowy.
          </p>
