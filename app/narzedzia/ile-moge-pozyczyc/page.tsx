...
export const metadata: Metadata = {
  title: "Ile mogę pożyczyć pod hipotekę? | PODHIPOTEKE24.PL",
  description:
    "Sprawdź maksymalną kwotę pożyczki hipotecznej na podstawie wartości Twojej nieruchomości. Wpisz szacunkową wartość nieruchomości i dowiedz się ile możesz pożyczyć. Narzędzie jest w trakcie budowy.",
};

export default function IleMogePozyczycPage() {
  return (
    <main>
      <PageHero heading="Ile mogę pożyczyć?" bgImage="/images/slide-1.jpg" />
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-[800px] mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-[#374151] text-lg leading-relaxed mb-10">
            Sprawdź maksymalną kwotę pożyczki hipotecznej na podstawie wartości
            Twojej nieruchomości. Wpisz szacunkową wartość nieruchomości i dowiedz
            się ile możesz pożyczyć. Narzędzie jest w trakcie budowy.
          </p>
