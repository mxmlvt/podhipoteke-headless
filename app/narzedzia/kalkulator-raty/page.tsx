...
export const metadata: Metadata = {
  title: "Kalkulator raty pożyczki hipotecznej | PODHIPOTEKE24.PL",
  description:
    "Nasz kalkulator raty pożyczki hipotecznej pozwoli Ci szybko obliczyć wysokość miesięcznej raty. Podaj kwotę, okres spłaty i oprocentowanie – wynik zobaczysz natychmiast. Narzędzie jest w trakcie budowy.",
};

export default function KalkulatorRatyPage() {
  return (
    <main>
      <PageHero heading="Kalkulator raty" bgImage="/images/slide-1.jpg" />
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-[800px] mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-[#374151] text-lg leading-relaxed mb-10">
            Nasz kalkulator raty pożyczki hipotecznej pozwoli Ci szybko obliczyć
            wysokość miesięcznej raty. Podaj kwotę, okres spłaty i oprocentowanie
            – wynik zobaczysz natychmiast. Narzędzie jest w trakcie budowy.
          </p>
