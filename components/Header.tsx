            ...
            <div className="flex items-center gap-1.5 border-l border-[#e5e7eb] pl-3">
              {socialLinks.map(({ label, href, path }) => (
                <a
                  ...
                  aria-label={label}
                  className="w-7 h-7 flex items-center justify-center rounded-full text-[#6b7280] hover:text-[#2299AA] hover:bg-[#e6f7f9] transition-colors"
                >
                    ...
                    <div className="flex items-center justify-center gap-3 pt-1">
                      {socialLinks.map(({ label, href, path }) => (
                        <a
                          ...
                          rel="noopener noreferrer"
                          aria-label={label}
                          className="w-9 h-9 flex items-center justify-center rounded-full bg-[#e6f7f9] text-[#1c435e] hover:bg-[#2299AA] hover:text-white transition-colors"
                        >
