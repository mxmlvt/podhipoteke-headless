              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full flex items-center justify-center gap-2 py-3 rounded-full bg-[#2299AA] hover:bg-[#2bb5c7] text-white font-semibold text-base transition-colors disabled:opacity-70"
                  >
                    {loading ? "Wysyłanie..." : (
                      <>
