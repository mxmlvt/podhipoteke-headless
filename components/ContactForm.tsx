...
export default function ContactForm() {
  ...
  return (
    <section id="formularz" className="bg-gradient-to-br from-[#1c435e] to-[#0f2a3d] py-16">
      <div className="max-w-[1330px] mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Left side – Benefits + contact info (navy bg, white text) */}
          <div>
            <h2 className="text-[2.1rem] font-bold text-white mb-8">WYPEŁNIJ FORMULARZ</h2>
            <ul className="space-y-4 text-white/90 text-[16px]">
              {[
                ...
                <li key={item} className="flex items-start gap-3">
                  <span className="shrink-0 mt-0.5 w-6 h-6 rounded-full bg-cta-green flex items-center justify-center">
            ...
            <div className="mt-10">
              <h3 className="text-[25px] font-semibold text-white mb-4">Kontakt tradycyjny</h3>
              <div className="space-y-3">
                <a href="mailto:kontakt@podhipoteke24.pl" className="flex items-center gap-3 text-white/80 hover:text-white transition-colors">
                ...
                <a href="tel:577873616" className="flex items-center gap-3 text-white/80 hover:text-white transition-colors">
                  <span className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center shrink-0">
          ...
          {/* Right side – Form with white inputs */}
          <div>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <input
                  ...
                  required
                  className="form-input bg-white text-[#111111]"
                />
                <input
                  type="tel"
                  name="phone"
              ...
              <label className="flex items-start gap-3 cursor-pointer pt-2">
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="mt-1.5 w-4 h-4 accent-cta-green"
                />
              ...
              <button type="submit" className="btn-cta-shine !px-8 !py-3 w-full sm:w-auto">
                Wyślij wniosek
              </button>
            </form>
          </div>
